...
(function (Reveal, $) {
  ...
  //  var base_url = '/resources/lib/reveal.js';
  ...
  Reveal.initialize({
    ...
    dependencies: [
      { src: '/resources/lib/reveal.js-plugin-externalcode/externalcode.js', condition: function() { return !!document.querySelector( '[data-code]' ); } },
